...
for k, v in l2_realigned.items():
    try:
        new_da = xr.DataArray(
            np.array(
                v.data), dims=['time_20_ku'], coords=dict(
                time_20_ku=l1b.coords['time_20_ku'].values, lat_20_ku=(
                    ['time_20_ku'], l1b.coords['lat_20_ku'].values), lon_20_ku=(
                    ['time_20_ku'], l1b.coords['lon_20_ku'].values)))
    except BaseException:
        pass
    l2_realigned[k] = new_da

l2_realigned['window_del_20_ku'] = xr.DataArray(
    l1b.window_del_20_ku.values, dims=['time_20_ku'], coords=dict(
        time_20_ku=l1b.coords['time_20_ku'].values, lat_20_ku=(
            ['time_20_ku'], l1b.coords['lat_20_ku'].values), lon_20_ku=(
                ['time_20_ku'], l1b.coords['lon_20_ku'].values)))
