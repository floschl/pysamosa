...
import numpy as np
from pysamosa.utils_plot import save_figs_to_pdf
from scipy import signal

from pysamosa.common_types import RetrackerBaseType, L1bSourceType, ProcMode
from pysamosa.data_access import data_vars_s3, data_vars_s6, data_vars_cs, data_vars_dart, data_vars_retracker
...
def test_retrack_s3(s3_eum_l1b, s3_eum_l2):
    ...
    rp = RetrackerProcessor(l1b_source=[l1b_file],
...
def test_retrack_cs(cs_eum_l1b, cs_eum_l2):
    l1b_src_type, retracker_basetype, preset = L1bSourceType.EUM_CS, RetrackerBaseType.SAM, SettingsPreset.NONE
