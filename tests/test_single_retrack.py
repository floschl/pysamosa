...
from pysamosa.common_types import L1bSourceType, RetrackerBaseType, ModelSettings, ProcMode
from pysamosa.data_access import get_subset_dataset, get_model_param_obj_from_l1b_data, data_vars_dart, data_vars_retracker, data_vars_s6
...
class TestRetrackingSingle:
    ...
    def test_retracking_single(
        ...
        elif l1b_src_type == L1bSourceType.EUM_S6_F04 or l1b_src_type == L1bSourceType.EUM_S6_F06:
            l1b, l2 = s6_eum_l1b, s6_eum_l2
        elif l1b_src_type == L1bSourceType.EUM_S6_F04_FFSAR or l1b_src_type == L1bSourceType.EUM_S6_F06_FFSAR:
